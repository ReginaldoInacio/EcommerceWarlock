bioEp.init({
  html:
    ...
    '<span></span>' +
    '<span></span>' +
    '<a href="#" target="_blank" class="bio_btn">Garantir frete Gratis! &nbsp; <i class="fa fa-instagram"></i></a>' +
    '</div>',
  css:
    '#bio_ep {width: 600px; height: 600px; color: #333; background-color: #fafafa; text-align: center;background-image: url(pop-up/imagens-pop/pop-up.png);background-size: cover;}' +
